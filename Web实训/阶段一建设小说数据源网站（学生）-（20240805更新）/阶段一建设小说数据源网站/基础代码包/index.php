    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <a href="novel_chapters.php?nid=1" class="wrapper">
                    <div class="thumbnail">
                        <img src="images/product_1.jpeg" alt="小说简介" class="img-responsive">
                        <div class="caption text-center">
                            <h3>小说名</h3>
                            <p>作者名<br>更新：2022-02-02 12:10:11</p>
                        </div>
                    </div>
                </a>
            </div>
