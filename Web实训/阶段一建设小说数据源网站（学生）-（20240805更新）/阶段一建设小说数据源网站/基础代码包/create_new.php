    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                <h1 class="text-center">创建小说</h1>
                <form class="form-horizontal" method="post">
                    <div class="form-group">
                        <label for="inputNovelName" class="col-sm-2 control-label">小说名</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputNovelName" name="novel_name" placeholder="小说名" required maxlength="15">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputNovelImage" class="col-sm-2 control-label">小说封面</label>
                        <div class="col-sm-10">
                            <input type="file" class="form-control" id="inputNovelImage" name="novel_image" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputNovelDesc" class="col-sm-2 control-label">小说介绍</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="inputNovelDesc" name="novel_desc" rows="10"></textarea>
                        </div>
                    </div>
